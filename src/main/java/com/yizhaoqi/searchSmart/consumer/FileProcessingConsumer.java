package com.yizhaoqi.searchSmart.consumer;

import com.yizhaoqi.searchSmart.config.KafkaConfig;
import com.yizhaoqi.searchSmart.model.FileProcessingTask;
import com.yizhaoqi.searchSmart.service.ParseService;
import com.yizhaoqi.searchSmart.service.VectorizationService;
    ...
    private InputStream downloadFileFromStorage(String filePath) throws ServerException, InsufficientDataException, ErrorResponseException, IOException, NoSuchAlgorithmException, InvalidKeyException, InvalidResponseException, XmlParserException, InternalException {
        ...
        try {
            ...
            if (filePath.startsWith("http://") || filePath.startsWith("https://")) {
                ...
                // 添加必要的请求头
                connection.setRequestProperty("User-Agent", "SearchSmart-FileProcessor/1.0");
